            ...
            <div className="bg-linear-to-r from-primary to-primary/90 text-white py-2.5 text-center text-xs sm:text-sm overflow-hidden">
                <div className="section-container animate-fade-in">
                    <p className="flex items-center justify-center gap-2 px-4">
                        ...
                        <span>Due to current circumstances, there may be slight delays in order processing</span>
                    </p>
                </div>
            </div>
            ...
            <div className="border-b border-gray-100 bg-white static top-0 z-40 shadow-sm">
                <div className="section-container">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-3 py-3">
                        ...
                        <ul className="hidden lg:flex items-center gap-1">
                            <li>
                                ...
                                >
                                    <img className="w-7 h-7 object-cover rounded-full" src="/images/about-us.jpg" alt="" />
                                    About Us
                                </NavLink>
                            </li>
                            <li>
                        ...
                        <div className="flex flex-col justify-center sm:flex-row items-start sm:items-center gap-3 sm:gap-5 text-xs sm:text-sm">
                            ...
                            <div className="hidden xl:flex items-center gap-2 text-gray-600 bg-green-50 px-3 py-1.5 rounded-lg">
                                <img src="/images/nav-icon.png" alt="secure" className="w-5 h-5" />
                                <span className="text-xs font-medium">100% Secure delivery without contacting the courier</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2 text-gray-600 hover:text-primary transition-colors cursor-pointer group">
                                ...
                                <span className="text-primary font-semibold text-sm">+0020 500</span>
                            </div>
                            ...
                            <div className="flex justify-center items-center gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <img src="/images/flags/en.png" alt="EN" className="w-4 h-4 rounded-full" onError={(e) => e.target.style.display = 'none'} />
                                        <span className="font-medium text-sm">English</span>
                                        <FiChevronDown className={`transition-transform duration-300 ${languageOpen ? 'rotate-180' : ''}`} />
                                    </button>
                                    ...
                                    {languageOpen && (
                                        <div className="absolute top-full right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-100 py-2 min-w-[100px] animate-slide-down z-50">
                                            <button className="w-full px-4 py-2 text-left hover:bg-primary/5 text-sm flex justify-center items-center gap-2 transition-colors">
                                                <img src="/images/flags/en.png" alt="EN" className="w-4 h-4" onError={(e) => e.target.style.display = 'none'} />
                                                English
                                            </button>
                                            <button className="w-full px-4 py-2 text-left hover:bg-primary/5 text-sm flex justify-center items-center gap-2 transition-colors">
                                                <img src="/images/flags/ar.png" alt="AR" className="w-4 h-4" onError={(e) => e.target.style.display = 'none'} />
                                                العربية
                                            </button>
                                        </div>
                                        )}
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            ...
                                            <FiChevronDown className={`transition-transform duration-300 ${currencyOpen ? 'rotate-180' : ''}`} />
                                        </button>
                                        ...
                                        {currencyOpen && (
                                            <div className="absolute top-full right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-100 py-2 min-w-20 animate-slide-down z-50">
                                                <button className="w-full px-4 py-2 text-center hover:bg-primary/5 text-sm transition-colors">USD</button>
                                                <button className="w-full px-4 py-2 text-center hover:bg-primary/5 text-sm transition-colors">EUR</button>
                                                <button className="w-full px-4 py-2 text-center hover:bg-primary/5 text-sm transition-colors">GBP</button>
                                            </div>
                                        )}
                                    </div>
                            </div>
                    ...
                    <div className="lg:hidden flex items-center justify-around border-t border-gray-100 py-2 text-xs">
                        ...
                        >
                            <img className="w-5 h-5 object-cover rounded-full" src="/images/about-us.jpg" alt="" />
                            About Us
                        </NavLink>
                        <NavLink to="/compare" className="px-3 py-1.5 text-gray-600 flex items-center gap-1">
                            <AiOutlineSync />
                            Compare
                        </NavLink>
                        <NavLink to="/wishlist" className="px-3 py-1.5 text-gray-600 flex items-center gap-1">
                            <AiOutlineHeart />
                            Wishlist
                        </NavLink>
                    </div>
