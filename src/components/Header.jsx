...
import { AiOutlineClose, AiOutlineSearch, AiOutlineUser, AiOutlineShoppingCart } from "react-icons/ai";
        ...
        <header className="bg-white sticky top-[52px] lg:top-[60px] z-30 shadow-md">
            <div className="section-container">
                ...
                <div className="flex justify-between items-center gap-4 py-3 sm:py-4">
                    ...
                    {/* Search Bar */}
                    <div className={`relative flex-1 max-w-2xl transition-all duration-300 ${searchFocused ? 'scale-[1.02]' : ''}`}>
                        <div className="relative">
                            <AiOutlineSearch className={`absolute left-4 top-1/2 -translate-y-1/2 text-xl transition-colors ${searchFocused ? 'text-primary' : 'text-gray-400'}`} />
                            <input 
                    ...
                    <div className="flex justify-between items-center gap-4 py-3 sm:py-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <span className="font-medium hidden sm:inline">ALL CATEGORIES</span>
                                <span className="font-medium sm:hidden">MENU</span>
                                <FaAngleDown className={`transition-transform duration-300 ${categoriesOpen ? 'rotate-180' : ''}`} />
                            </button>
                            ...
                            {categoriesOpen && (
                                <div className="absolute top-full left-0 mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 py-3 min-w-[250px] animate-slide-down z-50">
                                    <a href="#" className="px-5 py-3 hover:bg-primary/5 flex items-center gap-3 transition-all group">
                                        <img src="/images/meat.png" alt="" className="w-6 h-6 group-hover:scale-110 transition-transform" />
                                        <span className="text-gray-700 group-hover:text-primary font-medium">Meats & Seafood</span>
                                    </a>
                                    <a href="#" className="px-5 py-3 hover:bg-primary/5 flex items-center gap-3 transition-all group">
                                        <img src="/images/baker.png" alt="" className="w-6 h-6 group-hover:scale-110 transition-transform" />
                                        <span className="text-gray-700 group-hover:text-primary font-medium">Bakery</span>
                                    </a>
                                    <a href="#" className="px-5 py-3 hover:bg-primary/5 flex items-center gap-3 transition-all group">
                                        <img src="/images/cup.png" alt="" className="w-6 h-6 group-hover:scale-110 transition-transform" />
                                        <span className="text-gray-700 group-hover:text-primary font-medium">Beverages</span>
                                    </a>
                                </div>
                            )}
                        </div>
